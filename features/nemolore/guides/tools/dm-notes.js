/**
 * DM Notes Tool
 * A current-chat narrative scratchpad the AI uses to plan and track the story.
 * Stored as a tracker lorebook entry, always in context for this chat.
 *
 * The AI can:
...
export const TOOL_NAME = 'NLG_dm_notes';
...
export function getDefinition() {
    return {
        ...
        description: `A current-chat narrative scratchpad for planning and tracking the story — like a game master's private notebook. Use this to maintain story coherence across turns.
...
export async function initDMNotes() {
    ...
    console.log('[NemoLore:Guides] Initialized empty DM notes for new chat.');
}
